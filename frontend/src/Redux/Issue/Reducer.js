import { FETCH_ISSUES_REQUEST, CREATE_ISSUE_REQUEST, DELETE_ISSUE_REQUEST, FETCH_ISSUES_BY_ID_REQUEST, ASSIGN_ISSUE_TO_USER_REQUEST, FETCH_ISSUES_SUCCESS, FETCH_ISSUES_BY_ID_SUCCESS, UPDATE_ISSUE_STATUS_SUCCESS, CREATE_ISSUE_SUCCESS, ASSIGN_ISSUE_TO_USER_SUCCESS, DELETE_ISSUE_SUCCESS, FETCH_ISSUES_FAILURE, CREATE_ISSUE_FAILURE, DELETE_ISSUE_FAILURE, ASSIGN_ISSUE_TO_USER_FAILURE } from "./ActionType";
...
export const issueReducer = (state = intialState, action) => {
    switch (action.type) {
